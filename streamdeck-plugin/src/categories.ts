...
export const CATEGORY_META: Record<string, CategoryMeta> = {
  ...
  SPELLS_CAST:      { displayName: 'Spells Cast',  group: 'TYPE_BUFFS',  gradient: ['#1a001a', '#8e44ad'], iconFile: 'spells-cast.png',      isAbilityCounter: true },
  SPELLCRAFT_CAST:  { displayName: 'Spellcrafts',  group: 'TYPE_BUFFS',  gradient: ['#0d001a', '#6c3483'], iconFile: 'spellcraft-cast.png',  isAbilityCounter: true },
};
